...
def get_small_pomdp():
    ...
    q1.transitions['coin'].append((q1, 0.2))
    q1.transitions['coin'].append((q2, 0.8))

    q1.transitions['but'].append((q3, 1))

    q2.transitions['coin'].append((q2, 0.2))
    q2.transitions['coin'].append((q1, 0.8))
...
learned_model = run_stochastic_Lstar(input_al, sul, eq_oracle, automaton_type='mdp', min_rounds=400, max_rounds=500, strategy='normal')
